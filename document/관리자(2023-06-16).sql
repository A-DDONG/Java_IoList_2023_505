...
/*
생성한 iolist 사용자가 DB에 접속하고, TABLE 을 생성하고, CRUD 를 실행하는 부분을
각각 별도의 권한 정책에 의하여 허가를 해주어야한다
학습 목적상 세세한 권한 정책을 부여하기가 불편하여 Oracle 의 SYSDBA(SYSTEM) 권한보다
한단계 낮은 DBA 권한을 부여한다

DBA 권한은 Oracle DBMS System 설정을 변경하는 것 외에 대부분의 권한을 갖는다
*/
GRANT DBA iolist;